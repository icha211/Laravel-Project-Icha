...
<body>
    <div class="container">
        <div class="left-panel">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" id="signin-form">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label class="form-label">Email</label>
                    <div class="input-wrapper">
                        <span class="input-icon">✉</span>
                        <input type="email" name="email" class="form-control" placeholder="Enter your email" value="<?php echo e(old('email')); ?>" required autofocus>
                    </div>
                </div>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" id="signup-form" style="display: none;">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <select name="department" class="form-control" required style="padding-left: 45px;">
                            ...
                            <option value="IT Division" <?php echo e(old('department') == 'IT Division' ? 'selected' : ''); ?>>IT Division</option>
                            <option value="Finance Division" <?php echo e(old('department') == 'Finance Division' ? 'selected' : ''); ?>>Finance Division</option>
                        </select>
                    </div>
                </div>
...
<?php /**PATH C:\Users\User\Laravel-Project-Icha\resources\views/auth/login.blade.php ENDPATH**/ ?>