...
<body>
    ...
    <div class="sidebar">
        ...
        @auth
            ...
            @else
                <a href="{{ auth()->user()->employee ? route('employees.show', auth()->user()->employee) : '#' }}" class="nav-link">
                    <i class="fas fa-user"></i> My Profile
                </a>
                <a href="{{ auth()->user()->employee ? route('goals.index', auth()->user()->employee) : '#' }}" class="nav-link">
                    <i class="fas fa-target"></i> My Goals
                </a>
                <a href="{{ auth()->user()->employee ? route('training.index', auth()->user()->employee) : '#' }}" class="nav-link">
