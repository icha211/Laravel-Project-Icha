        ...
        <div class="sidebar-menu">
            ...
            @auth
                @if(auth()->user()->isEmployer())
                    ...
                    <a href="{{ route('performance-reviews.index') }}" class="menu-item {{ request()->routeIs('performance-reviews.*') ? 'active' : '' }}">
                ...
                @else
                    <a href="{{ auth()->user()->employee ? route('employees.show', auth()->user()->employee) : '#' }}" class="menu-item {{ request()->routeIs('employees.show') ? 'active' : '' }}">
                        <i class="fas fa-user"></i>
                        <span>My Profile</span>
                    </a>
                    <a href="{{ auth()->user()->employee ? route('goals.index', auth()->user()->employee) : '#' }}" class="menu-item {{ request()->routeIs('goals.*') ? 'active' : '' }}">
                        <i class="fas fa-bullseye"></i>
                        <span>My Goals</span>
                    </a>
                    <a href="{{ auth()->user()->employee ? route('training.index', auth()->user()->employee) : '#' }}" class="menu-item {{ request()->routeIs('training.*') ? 'active' : '' }}">
                        <i class="fas fa-graduation-cap"></i>
                        <span>Training</span>
                    </a>
                @endif
